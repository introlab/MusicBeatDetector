#ifndef MUSIC_BEAT_DETECTOR_UTILS_DATA_ARRAY_TO_PCM_CONVERTER_H
#define MUSIC_BEAT_DETECTOR_UTILS_DATA_ARRAY_TO_PCM_CONVERTER_H

#include <MusicBeatDetector/Utils/Data/PcmAudioFrameFormat.h>
#include <MusicBeatDetector/Utils/TypeTraits.h>
